...
export const getStaticProps: GetStaticProps<{proposal: ProposalType}> = async () => {
...
export default function ProposalPage({proposal}: InferGetServerSidePropsType<typeof getStaticProps>) {
  return (

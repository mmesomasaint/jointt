...
function SelectContractors({ contractorTypes }: { contractorTypes: string[] }) {
  const contractors: { name: string; role: string; pay: string }[] = [
    { name: 'Obi CUbana', role: 'Structural', pay: '$30/hr' },
    { name: 'Nneoma James', role: 'Cook', pay: '$10/hr' },
  ...
  return (
    <div className='overflow-scroll'>
      ...
      {contractors.map(({ name, role, pay }) => (
        <div className='p-3 rounded-xl border border-gray-900/20 bg-blue-600/30 my-3'>
